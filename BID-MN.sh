...
wget https://github.com/blockidchain/bidv2/releases/download/v2.0.1/bid-2.0.1-ubuntu-daemon.tar.gz
...
cd ~/.blockidcoin && wget https://github.com/blockidchain/bidv2/releases/download/v2.0.1/bootstrap.zip
